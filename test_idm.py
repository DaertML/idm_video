...
def predict_video_actions(video_path, model):
    ...
    and displays the annotated video.
    """
    ...
    while True:
        ...
        # 4. Display the results on the original F_t frame (since A_t happens AFTER F_t)
        # We display the prediction on the F_t_plus_1 frame since that is the CURRENT frame
        ...
        # 5. Advance the frames for the next iteration
    ...
    print(f"Video processing finished after {frame_count} frames.")


if __name__ == '__main__':
    print("--- Inverse Dynamics Model Prediction ---")
